...
def calc_path_number(birthdate)
	i = 0
	digit_sum = 0
...
def setup_index_view
	...
	birth_path_number = calc_path_number(birthdate)
...
post '/' do
	...
	if valid_birthdate(birthdate)
		...
		@warning = "Oops! It looks like you didn't enter a valid birthdate. Please use the format MMDDYYYY."
		erb :form
